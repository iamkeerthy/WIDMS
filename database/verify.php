...
$tables=['users','suppliers','inventory_items','stock_receipts','supplier_payments','activity_logs','districts','ds_divisions','gn_divisions','item_categories','eligibility_rules','beneficiaries','beneficiary_registration_requests','goods_requests','division_inventory','officer_pools','pool_allocations','aid_requests','distributions','item_returns','vision_camps','vision_camp_handovers','contact_lens_stock','contact_lens_orders','correction_requests'];
